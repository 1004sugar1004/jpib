...
export const RhythmTrainingGame = ({ soundEnabled }: RhythmTrainingGameProps) => {
  ...
  useEffect(() => {
    ...
    const SONGS = [
      { name:'우리들의 Super Power', bpm:128, offset:550, url:'https://ik.imagekit.io/foefnjeua/%EC%9A%B0%EB%A6%AC%EB%93%A4%EC%9D%98%20Super%20Power.mp3?updatedAt=1773797977356' },
      { name:'개념송 (Remastered)', bpm:120, offset:450, url:'https://ik.imagekit.io/foefnjeua/%EA%B0%9C%EB%85%90%EC%86%A1%20(Remastered).mp3?updatedAt=1774403985367' },
      { name:'ATL 다섯 가지 힘', bpm:132, offset:350, url:'https://ik.imagekit.io/foefnjeua/ATL%20%EB%8B%A4%EC%84%AF%20%EA%B0%80%EC%A7%80%20%ED%9E%98.mp3?updatedAt=1774403985153' },
    ];
