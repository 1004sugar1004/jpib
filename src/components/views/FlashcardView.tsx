            ...
            >
              ...
              <div className="absolute inset-0 backface-hidden">
                <Card className="w-full h-full p-12 flex flex-col items-center justify-center text-center space-y-8 border-4 border-indigo-50 overflow-visible">
                  {currentCard.image && (
                    <div className="w-32 h-32 bg-gray-50 rounded-3xl p-4">
              ...
              <div className="absolute inset-0 backface-hidden rotate-y-180">
                <Card className="w-full h-full p-12 flex flex-col items-center justify-center text-center space-y-6 bg-indigo-600 text-white border-4 border-white/20 overflow-visible">
                  <h4 className="text-xl font-black opacity-80">설명</h4>
                  ...
                  {currentCard.details && currentCard.details.length > 0 && (
                    <div className="pt-6 border-t border-white/20 w-full">
                      <p className="text-sm font-black opacity-60 mb-3 uppercase tracking-widest">실천 예시</p>
                      <p className="text-sm opacity-90 italic">"{currentCard.details[0]}"</p>
                    </div>
                  )}
                </Card>
              </div>
