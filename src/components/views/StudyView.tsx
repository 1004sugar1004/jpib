...
const CONSONANT_QUESTIONS: ConsonantQuestion[] = [
  ...
  { word: "사고하는 사람", consonants: "ㅅㄱㅎㄴ ㅅㄹ", category: "학습자상", description: "문제를 발견하고 창의적이고 비판적인 사고를 통해 윤리적이고 합리적인 결정을 내리는 사람입니다." },
  ...
  { word: "균형 잡힌 사람", consonants: "ㄱㅎ ㅈㅎ ㅅㄹ (또는 ㄱㅎ ㅈㅍ ㅅㄹ)", category: "학습자상", description: "지성, 신체, 감성이 조화를 이룰 수 있도록 균형을 유지하고, 자신과 세계의 웰빙을 성실하게 가꾸는 사람입니다." },
