...
const DEFAULT_EFFECT_OPTIONS: Required<Omit<HyperspeedOptions, 'colors'>> & { colors: HyperspeedColors } = {
  onSpeedUp: () => {},
  onSlowDown: () => {},
...
const distortions: Record<string, { uniforms: any; getDistortion: string; getJS?: (progress: number, time: number) => THREE.Vector3 }> = {
  mountainDistortion: {
...
export const Hyperspeed: React.FC<{ effectOptions?: HyperspeedOptions }> = ({ effectOptions }) => {
  ...
  useEffect(() => {
    ...
    // Retrieve requested distortion implementation
